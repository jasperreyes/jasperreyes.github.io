$(document).ready(function() {
	...
	$('#launchButton').click(function() {
		...
		$('#site_container').delay(500).fadeIn(500);
		$('#earth_container').delay(500).fadeIn(500);
		$('#earth_container').delay(35000).fadeOut(500);
		$('#mars_container').delay(35000).fadeIn(500);
		$('#finish_container').delay(50000).fadeIn(500);
	});
});
