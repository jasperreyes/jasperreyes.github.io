...
$(document).ready(function() {
	$('#level1').mouseenter(function() {
		$('#container').delay(300).css('background-color','#000066');
	});
	$('#level1').mouseleave(function() {
		$('#container').delay(300).css('background-color','#000066');
	}); 
	$('#level2').mouseenter(function() {
		$('#container').delay(300).css('background-color','#000099');
	});
	$('#level2').mouseleave(function() {
		$('#container').delay(300).css('background-color','#000066');
	});
	$('#level3').mouseenter(function() {
		$('#container').delay(300).css('background-color','#0000CC');
	});
	$('#level3').mouseleave(function() {
		$('#container').delay(300).css('background-color','#000099');
	});
	$('#level4').mouseenter(function() {
		$('#container').delay(300).css('background-color','#3300CC');
	});
	$('#level4').mouseleave(function() {
		$('#container').delay(300).css('background-color','#0000CC');
	});
	$('#level5').mouseenter(function() {
		$('#container').delay(300).css('background-color','#6600CC');
	});
	$('#level5').mouseleave(function() {
		$('#container').delay(300).css('background-color','#3300CC');
	});
	$('#level6').mouseenter(function() {
		$('#container').delay(300).css('background-color','#9900CC');
	});
	$('#level6').mouseleave(function() {
		$('#container').delay(300).css('background-color','#6600CC');
	});
	$('#level7').mouseenter(function() {
		$('#container').delay(300).css('background-color','#CC00CC');
	});
	$('#level7').mouseleave(function() {
		$('#container').delay(300).css('background-color','#9900CC');
	});
	$('#level8').mouseenter(function() {
		$('#container').delay(300).css('background-color','#CC0099');
	});
	$('#level8').mouseleave(function() {
		$('#container').delay(300).css('background-color','#CC00CC');
	});
	$('#level9').mouseenter(function() {
		$('#container').delay(300).css('background-color','#CC0066');
	});
	$('#level9').mouseleave(function() {
		$('#container').delay(300).css('background-color','#CC0099');
	});
	$('#level10').mouseenter(function() {
		$('#container').delay(300).css('background-color','#CC0033');
	});
	$('#level10').mouseleave(function() {
		$('#container').delay(300).css('background-color','#CC0066');
	});
	$('#level11').mouseenter(function() {
		$('#container').delay(300).css('background-color','#CC0000');
	});
	$('#level11').mouseleave(function() {
		$('#container').delay(300).css('background-color','#CC0033');
	});
	$('#level12').mouseenter(function() {
		$('#container').delay(300).css('background-color','#FF0000');
	});
